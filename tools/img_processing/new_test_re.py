...
IMAGE_PATHS = "/data/yunjin/last/salmon/retest"
SAVE_PATHS = "/data/yunjin/last/mmdetection/salmonimg/retest"
...
#    # detect the corners
   corners = cv2.goodFeaturesToTrack(blur, 4, 0.01, 550, blockSize = 20)  # four points
