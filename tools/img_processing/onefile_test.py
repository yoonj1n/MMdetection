...
# IMAGE_PATHS = "/data/khyunjung/mm_sal/annotation/images/my_test"
SAVE_PATHS = "/data/yunjin/last/mmdetection/salmonimg/onetest"
...
file ="/data/yunjin/last/mmdetection/configs/_base_/salmon/work_dirs/mask_1x_salmon_r101_dataset2/test/m14_180.jpg"

img = cv2.imread(file)
result = perspective_correction(img)
#height, width = result.shape[:2]
#print(height, width)
name = os.path.join(SAVE_PATHS,file.split('/')[-1])
