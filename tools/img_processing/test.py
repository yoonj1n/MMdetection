...
####img path ->"/data/khyunjung/mm_sal/annotation/images/my_test"
...
SAVE_PATHS = "/data/yunjin/last/mmdetection/salmonimg/test"
...
for file in file_list:
   if file.endswith(('.jpg', '.JPG', '.jpeg', 'JPEG', '.png', 'PNG')):
      ...
      img = cv2.imread(src)
      result = perspective_correction(img,2250,4000)
