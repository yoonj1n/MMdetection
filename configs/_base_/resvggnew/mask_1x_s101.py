...
_base_ = '/data/yunjin/last/mmdetection/configs/resnest/mask_rcnn_s101_fpn_syncbn-backbone+head_mstrain_1x_coco_cafe.py'
...
load_form = '/home/yunjin/.cache/torch/hub/checkpoints/resnest101_d2-f3b931b2.pth'
